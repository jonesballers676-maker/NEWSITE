...
<body><nav>
  <a href="../index.html" class="nav-logo" aria-label="Robert Jones Roofing home">
  ...
  <ul class="nav-links">
    ...
    <li class="has-drop"><a href="#">Services &#9662;</a>
      <ul class="dropdown">
        ...
        <li><a href="../soft-washing.html">Soft Washing</a></li>
      </ul>
    </li>
...
<section class="section section-alt">
  <div class="reveal" style="max-width:920px;margin:0 auto;">
    <p style="margin-bottom:1.25rem;"><a href="../blog.html" style="color:var(--blue-bright);text-decoration:none;font-weight:600;letter-spacing:0.04em;text-transform:uppercase;">&larr; Back to Blog</a></p>
...
<section class="cta-band">
  ...
  <a href="../quotes.html" class="btn btn-white btn-lg">Get Your Free Quote</a>
  ...
  <div class="footer-col">
    ...
    <ul>
      ...
      <li><a href="../soft-washing.html">Soft Washing</a></li>
      <li><a href="../quotes.html">Free Estimate</a></li>
      <li><a href="../our-work.html">Our Work</a></li>
    </ul>
  </div>
  <div class="footer-col">
...
foreach ($item in $toImport) {
  ...
  try {
    ...
    $postRelativeHref = "blog/$fileSlug.html"
    $description = $excerpt
